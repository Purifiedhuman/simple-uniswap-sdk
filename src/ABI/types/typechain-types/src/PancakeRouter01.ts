...
export interface PancakeRouter01Interface extends utils.Interface {
  functions: {
...
export interface PancakeRouter01 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PancakeRouter01Interface;
