...
export interface IPancakeMigratorInterface extends utils.Interface {
  functions: {
...
export interface IPancakeMigrator extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IPancakeMigratorInterface;
